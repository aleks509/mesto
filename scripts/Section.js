...
// Класс Section не имеет представления. Он получает готовую разметку и вставляет её в DOM.
//  Разметка может приходить в Section из любого класса, который её генерирует.
//   Класс Section обработает разметку из любого источника.
